...
public class Constants {
    ...
    public static String finalConfigPath = spltstr + "resources" + spltstr + "config" + spltstr;

    private static Resource dbResource = new ClassPathResource(finalConfigPath + "db.properties");
    ...
    public static void init() {
        //日志初始化
        PropertyConfigurator.configure(configPath + finalConfigPath + "log4j.properties");
        try {
            //配置初始化
